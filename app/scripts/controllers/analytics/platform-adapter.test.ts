...
describe('createPlatformAdapter', () => {
  ...
  describe('track', () => {
    ...
    it('forwards context, messageId, timestamp, and callback from invocation options', () => {
      const { adapter, segment } = buildAdapter();
  ...
  describe('identify', () => {
    ...
    it('forwards invocation options (context / messageId / timestamp / callback)', () => {
      const { adapter, segment } = buildAdapter();
      const callback = jest.fn();
      const timestamp = new Date('2026-01-01T00:00:00Z');
      adapter.identify('user-1', { plan: 'pro' }, {
  ...
  describe('view', () => {
    ...
    it('forwards properties and invocation options', () => {
      const { adapter, segment } = buildAdapter();
      const callback = jest.fn();
      const timestamp = new Date('2026-01-01T00:00:00Z');
